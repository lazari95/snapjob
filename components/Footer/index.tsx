        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  Welcome to SNAPJOB – your trusted partner in job placement and career development.
                </p>
                ...
                <a
                  href="mailto:contact@snapjob.com"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_top text-center text-sm text-bodydark dark:text-bodydarkdark"
            >
              <p>
                &copy; {new Date().getFullYear()} <span className="font-medium text-primary">SNAPJOB</span>. All Rights Reserved.
              </p>
            </motion.div>
          </div>
          {/* <!-- Footer Bottom --> */}
